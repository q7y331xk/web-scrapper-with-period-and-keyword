...
def search_each_period(periods, cookies):
    ...
    page = session.get(f"https://cafe.naver.com/ArticleSearchList.nhn?search.clubid=20486145&search.menuid=214&search.media=0&search.searchdate=2021-01-012021-01-01&search.defaultValue=1&userDisplay=50&search.onSale=1&search.option=3&search.sortBy=date&search.searchBy=0&search.query=%C6%C7%B8%C5%26&search.viewtype=title&search.page=1")
